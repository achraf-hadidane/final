...
$sql = "SELECT id, username, city FROM users WHERE profession = 'painting'";
...
$cities_sql = "SELECT DISTINCT city FROM users WHERE profession = 'painting' ORDER BY city";
