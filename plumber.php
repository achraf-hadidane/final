...
$sql = "SELECT id, username, city FROM users WHERE profession = 'plumber'";
...
$cities_sql = "SELECT DISTINCT city FROM users WHERE profession = 'plumber' ORDER BY city";
...
<body>
    ...
    <div class="filter-container">
            <form method="GET" action="plumber.php">
