...
// Build SQL query
$sql = "SELECT id, username, city FROM users WHERE profession = 'architect'";
...
$cities_sql = "SELECT DISTINCT city FROM users WHERE profession = 'architect' ORDER BY city";
...
<head>
    ...
    <title>Architects - KHADAMATI</title>
    <!-- Swiper CSS -->
...
<body>
    ...
    <div class="filter-container">
            <form method="GET" action="architecte.php">
        ...
        <div class="swiper mySwiper container">
            <div class="swiper-wrapper content">
                <?php foreach ($architects as $user): ?>
                <div class="swiper-slide card">
                    <div class="card-content">
                        <div class="image">
                        <img src="imgs/ar.png" alt="Profile Image" />
                        </div>
