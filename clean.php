...
$sql = "SELECT id, username, city FROM users WHERE profession = 'clean'";
...
$cities_sql = "SELECT DISTINCT city FROM users WHERE profession = 'clean' ORDER BY city";
...
<body>
    ...
    <div class="filter-container">
            <form method="GET" action="clean.php">
