...
$sql = "SELECT id, username, city FROM users WHERE profession = 'electrician'";
...
$cities_sql = "SELECT DISTINCT city FROM users WHERE profession = 'electrician' ORDER BY city";
...
<body>
    ...
    <div class="filter-container">
            <form method="GET" action="electrician.php">
